...
import { FaBullseye, FaCalendarAlt, FaExternalLinkAlt, FaArrowLeft } from "react-icons/fa";
            ...
            <>
                ...
                <main className="min-h-screen flex items-center justify-center">
                    <div className="text-center">
                        <h1 className="text-2xl font-bold mb-4">Program Kerja tidak ditemukan</h1>
        ...
        <>
            ...
            <main className="min-h-screen bg-slate-50 pt-24 pb-16">
                <div className="container mx-auto px-4 max-w-4xl">
                    <Link href={`/department/${progenda.department_id}`} className="inline-flex items-center gap-2 text-slate-500 hover:text-primary mb-8 transition-colors">
                    ...
                    <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
                        ...
                        <div className="bg-slate-900 text-white p-8 md:p-12 relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <h1 className="text-3xl md:text-5xl font-bold mb-4">{progenda.name}</h1>
                                <p className="text-slate-300 text-lg max-w-2xl">{progenda.description}</p>
                            </div>
                        </div>
                            ...
                            <div className="md:col-span-2 space-y-8">
                                <div>
                                    <h2 className="text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
                                        <span className="w-1.5 h-6 bg-primary rounded-full"></span> Tujuan
                                    </h2>
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
                                        <span className="w-1.5 h-6 bg-accent rounded-full"></span> Detail Program
                                    </h2>
                                ...
                                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 sticky top-24">
                                    ...
                                    <div className="space-y-3 text-sm text-slate-600">
                                        <div className="flex justify-between border-b border-slate-200 pb-2">
                                            ...
                                            <span className="font-medium text-slate-900">{progenda.timeline}</span>
                                        </div>

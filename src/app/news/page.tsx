            ...
            <main className="min-h-screen bg-slate-50 pt-24 pb-16">
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                        <div>
                            <h1 className="text-4xl font-bold text-slate-900 mb-2">Berita & Artikel</h1>
                            <p className="text-slate-500">Update terbaru seputar kegiatan dan informasi HIMASAKTA ITS</p>
                        </div>
                            ...
                            >
                                ...
                                <div className="p-6 flex-1 flex flex-col">
                                    <div className="text-xs text-slate-500 mb-2 font-medium">
                                        {format(new Date(item.published_at), "dd MMMM yyyy", { locale: idLocale })}
                                    </div>
                                    ...
                                    <span className="text-primary font-semibold text-sm">Baca Selengkapnya &rarr;</span>
                                </div>
                            </Link>
                        ))}
                    </div>

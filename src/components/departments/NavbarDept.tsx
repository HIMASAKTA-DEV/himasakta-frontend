...
export default function NavbarDept({ className }: { className?: string }) {
  ...
  return (
    <div className="sticky top-8 w-full flex flex-col z-[600] justify-center items-center">
      <small className="text-gray-500 max-lg:animate-marquee lg:animate-none">
        Hold shift + scroll to scrolling horizontally
      </small>
      <nav
        className={clsxm(
          "flex mt-2 w-full bg-white/80 backdrop-blur-2xl shadow-md rounded-full ring-1 ring-primaryPink/50",
          className,
        )}
      >

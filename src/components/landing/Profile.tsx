                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                                ...
                                <p className="text-slate-600 pl-4 whitespace-pre-line">{cabinet.misi}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        <div className="aspect-square rounded-3xl overflow-hidden shadow-2xl rotate-3 transition-transform hover:rotate-0 duration-500">
                            {/* Placeholder Image */}
                            <div className="w-full h-full bg-slate-200 flex items-center justify-center bg-[url('https://images.unsplash.com/photo-1523580494863-6f3031224c94?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center">
                            </div>
                        </div>
                        {/* Decorative elements */}

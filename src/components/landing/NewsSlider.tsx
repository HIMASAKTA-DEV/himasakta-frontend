            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center mb-12">
                    <div className="text-center md:text-left mb-6 md:mb-0">
                        <h2 className="text-primary font-bold tracking-wider uppercase text-sm mb-2">Update Terkini</h2>
                        <h3 className="text-3xl md:text-4xl font-bold text-slate-900">Berita & Artikel</h3>
                    </div>
                    <Link
                        href="/news"

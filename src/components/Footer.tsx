            ...
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <h2 className="text-2xl font-bold text-white mb-4">HIMASAKTA ITS</h2>
                        <p className="mb-6 max-w-sm text-slate-400">
                            Himpunan Mahasiswa Teknik Aktuaria Institut Teknologi Sepuluh Nopember.
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-2">
                            ...
                            <li><Link href="/#departments" className="hover:text-primary transition-colors">Departemen</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-2">
                            ...
                            <li><a href="https://its.ac.id" className="hover:text-primary transition-colors">Website ITS</a></li>
                            <li><a href="https://actuarial.its.ac.id" className="hover:text-primary transition-colors">Aktuaria ITS</a></li>
                        </ul>
                    </div>
                </div>

                <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
                    <p>© {new Date().getFullYear()} HIMASAKTA ITS. All rights reserved.</p>

                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/" className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            <span className={clsx("font-bold text-lg leading-tight", scrolled ? "text-slate-800" : "text-white")}>
                                HIMASAKTA
                            </span>
                            <span className={clsx("text-xs font-medium", scrolled ? "text-slate-500" : "text-white/80")}>
                                ITS Surabaya
                            </span>
                        </div>
                    </Link>
                    ...
                    <button
                        ...
                        className={twMerge("md:hidden p-2 rounded-md", scrolled ? "text-slate-800" : "text-white")}
                    >

      ...
      <div className="flex flex-col gap-3 w-full max-w-5xl mx-auto">
        ...
        <div
          className={clsx(
            ...
            "aspect-video lg:aspect-auto lg:h-[55vh] shimmer-skeleton",
          )}
        >
          {/* Subtle Inner Glow to mimic depth */}
          <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/5 to-transparent shimmer-skeleton" />
        </div>
      </div>
    </div>
  );
